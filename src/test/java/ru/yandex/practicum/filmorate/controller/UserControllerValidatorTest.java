...
class UserControllerValidatorTest extends BaseControllerValidatorTest<User> {
    ...
    void shouldThrowExceptionIfUserEmailDoesNotExist() {
        ...
        assertThrows(ValidationException.class, () -> validator.validate(testUser));
        assertThrows(ValidationException.class, () -> validator.validate(testUser2));
    }
